...
const Products = () => {
  ...
  const categories = useMemo(() => {
    if (!products) return [];
    return [...new Set(products.map((product: Product) => product.category))].filter(Boolean);
  }, [products]);
        ...
        <main className="flex-grow">
          <section className="py-20">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-white text-lg mb-4">Chargement des produits...</p>
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-b from-winshirt-purple/20 to-transparent py-16">
