...
const Hero: React.FC<HeroProps> = ({ className }) => {
  return (
    <section className={cn('relative min-h-screen flex items-center pt-16', className)}>
      {/* Background elements - simplifié pour de meilleures performances */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/4 w-72 h-72 bg-winshirt-purple/15 rounded-full filter blur-3xl animate-pulse-light" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-winshirt-blue/15 rounded-full filter blur-3xl animate-pulse-light" style={{ animationDelay: '1s' }} />
      </div>

      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          {/* Contenu critique sans délai d'animation pour améliorer le LCP */}
          ...
          {/* Boutons principaux sans délai */}
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up mb-16">
            <a href="/products">
          ...
          {/* Statistiques avec délai d'animation pour ne pas impacter le LCP */}
      ...
      {/* Bouton de scroll avec délai pour ne pas impacter le LCP */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2" style={{ animationDelay: '0.8s' }}>
        <button 
